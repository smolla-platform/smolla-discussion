...
Discussion service owning threads, posts, replies, reactions, votes, polymorphic anchors to slides, links, and events, and moderation actions.

## Repository layout

```
backend/
    src/Smolla.Discussion.Host/   ASP.NET Core web host
    tests/Smolla.Discussion.Tests/ xUnit unit + integration tests
```
...
dotnet build
dotnet test
dotnet run --project src/Smolla.Discussion.Host
```
